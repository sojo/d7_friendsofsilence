 ...
 */
function fos_zen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['fos_zen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('fos_zen sample setting'),
  '#default_value' => theme_get_setting('fos_zen_example'),
